...
static void listbox_owner_draw(DRAWITEM_HDR *ds)
{
	...
	//一个listbox绘到hdc0中．
	_draw_listbox(hdc,hwnd,RGB888(168,168,168),RGB888(250,250,250),RGB888(10,100,100), 24);
...
static void date_OwnerDraw(DRAWITEM_HDR *ds)
{
  ...
  RECT rc1 = {50, 34, 130, 72};
  RECT rc3 = {79, 261, 72, 36};
  ...
  /* 显示月日 */
  RECT rc_mont    = {30, 120, 50, 50};
  RECT rc_mont_zh = {80, 134, 30, 30};
  RECT rc_mday    = {125, 120, 50, 50};
  RECT rc_mday_zh = {175, 134, 30, 30};
