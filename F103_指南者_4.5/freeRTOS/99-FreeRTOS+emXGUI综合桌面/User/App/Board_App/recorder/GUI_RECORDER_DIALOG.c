...
recorder_icon_t record_icon[] = {
   ...
   {L"U",        {49,  308, 64, 64},   ID_RECORD_STOP},      // 5. 停止录音
   {L"U",        {171, 308, 64, 64},   ID_RECORD_START},     // 6. 开始录音
   {L"U",        {171, 308, 72, 72},   ID_RECORD_PADNC},     // 7. 暂停继续
   {L"O",        {740,   0, 60, 48},   ID_RECORD_EXIT},      // 8. 退出

   {L"录音机",   {86,  85, 120, 30},   ID_RECORD_STATE},     // 9. 正在录音
   {L"00:00",    {96, 187,100, 30},   ID_RECORD_TIME},      // 10. 录音时长
...
//        FillRect(hdc, &rc1);
				...
				RECT rc_grad = {290, 0, 5, GUI_YSIZE};
